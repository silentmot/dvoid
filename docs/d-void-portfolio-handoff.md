# DvoiD Developer Portfolio - Technical Handoff
...
| ------ | --------------- | ------------- |
| Home | "DvoiD - Technical Operations Specialist" | Full tagline |
| About | "About - DvoiD" | Bio summary |
| Projects | "Projects - DvoiD" | Projects overview |
| Project | "{title} - DvoiD" | Project description |
| Case Study | "{title} - DvoiD" | Case study description |
| Uses | "Uses - DvoiD" | Tools and setup |
| Contact | "Contact - DvoiD" | Contact info |
  ...
  images: [
    {
      ...
      width: 1200,
      height: 630,
      alt: "DvoiD - Technical Operations Specialist",
    },
  ],
};
```
