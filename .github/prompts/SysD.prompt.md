...
> Review the file **`EcoOps-DashboardGuide.md`** thoroughly to understand the entire design system and its structure.
>
...
>
> **Goal:** Produce a definitive, future-proof design foundation for the EcoOps ecosystem consistent across all apps and packages.
