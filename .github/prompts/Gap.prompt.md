...
`docs/Components/Admin/RoleManagement.md`

**2. Source Code:**

`components/admin/rbac/RoleManagement.tsx`
...
Generate a structured report. For each gap found, provide a clear description, reference the specific location in both the documentation and code (if applicable), and categorize it. In `docs/Agent/GapAnalysis{ReportName}.*.md`, use the following format:
